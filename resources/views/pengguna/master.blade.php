                        ...
                        <div class="col-md-6 col-lg-3">
                            <div class="block-5 mb-5">
                                ...
                                <ul class="list-unstyled">
                                    <li class="address">STIMIK ESQ, TB Simatupang, Jakarta Selatan.</li>
                                    <li class="phone"><a href="tel://+6282213188569">+62822 1316 8569</a></li>
                                    <li class="email">iwanate01@gmail.com</li>
                                </ul>
                            </div>
                        </div>
                        <div class="col-md-6 col-lg-4">
                                <div class="block-5 mb-5">
                                    ...
                                    <p class="text-justify">
                                        Mau lebih banyak traffic, link, pelanggan, dan sebuah situs web yang menghasilkan keuntungan? YoayoStore memberikan solusi yang Anda butuhkan untuk berhasil.
                                    </p>
                                </div>
                            </div>
                    </div>
