...
<head>
    ...
    <title> MTOAdmin | @yield('title')</title>
...
<div class="wrapper">
    ...
    <header class="main-header">
        ...
        <span class="logo-mini"><b>MTO</span>
        <!-- logo for regular state and mobile devices -->
        <span class="logo-lg"><b>MTO</b>Admin</span>
        </a>
    ...
    <footer class="main-footer">
        ...
        <!-- Default to the left -->
        <strong>Copyright &copy; 2019 <a href="{{ route('beranda') }}">YoayoStore</a>.</strong> All rights reserved.
    </footer>
</div>
<!-- ./wrapper -->
